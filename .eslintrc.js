module.exports = {
  ...
  "rules": {
    ...
    /* Stylistic Issues */
    "array-bracket-spacing": [ 1, "always", { "singleValue": false, "objectsInArrays": false, "arraysInArrays": false } ], //enforce spacing inside array brackets (fixable)
    ...
    "object-shorthand": 0, // (see Babel section) require method and property shorthand syntax for object literals
